<?php
    ...
    class AvataModel
    {
         ...
         * @return [type]               [description]
         */
        public function getTransaction($operation_id){
         ...
         * @return [type]           [description]
         */
        public function issue($data,$flag = false){

            $cate_id        = isset($data['cate_id']) ? $data['cate_id'] : '';
            $title          = isset($data['title']) ? $data['title'] : '';
            $uri            = isset($data['uri']) ? $data['uri'] : '';
            $uri_hash       = isset($data['uri_hash']) ? $data['uri_hash'] : '';
            $data           = isset($data['data']) ? $data['data'] : '';
            $recipient      = isset($data['recipient']) ? $data['recipient'] : $this->chain_address;
            ...
            //         $resp = $this->getTransaction($operation_id);
            //         var_dump($resp);
            //         return $resp;
            //     }
            //     return $result;
         ...
         * @return [type]           [description]
         */
        public function get_issue($data){
            ...
            $owner          = isset($data['owner']) ? $data['owner'] : $this->chain_address;
            $status         = isset($data['status']) ? $data['status'] : 'active';
            $start_date     = isset($data['start_date']) ? $data['start_date'] : '';
            $end_date       = isset($data['end_date']) ? $data['end_date'] : '';
            $sort_by        = isset($data['sort_by']) ? $data['sort_by'] : 'DATE_DESC';
            $tx_hash        = isset($data['tx_hash']) ? $data['tx_hash'] : '';
